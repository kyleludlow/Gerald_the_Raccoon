function projectileCollision({projectile, mobs, tileSize}, levels) {
	...
	var rowOverlap = (projectile.y%tileSize) + projectile.height;
        ...
        if((levels.map[baseRow][baseCol+1] && !levels.map[baseRow][baseCol]) || (levels.map[baseRow+1][baseCol+1] && !levels.map[baseRow+1][baseCol])){
    ...
    if(projectile.yVelocity>0){
        if((levels.map[baseRow+1][baseCol] && !levels.map[baseRow][baseCol]) || (levels.map[baseRow+1][baseCol+1] && !levels.map[baseRow][baseCol+1])){
