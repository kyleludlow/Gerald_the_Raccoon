...
var Mob = function(options) {
  ...
  // change to tileWidth and tileHeight for readability
...
// what is the significance of 0.03?
  var moveX = dx * 0.03;
  var moveY = dy * 0.03;


// why if moveX?
// Ask Simon and Connie
  if (moveX) {
...
Mob.prototype.chooseAction = function() {
  if ( // best distance i could find without it crashing
